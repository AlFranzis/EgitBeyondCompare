 ...
 * command group.
 */
public abstract class BeyondCompareRepositoryAction extends AbstractHandler implements
	...
	private final BeyondCompareRepositoryActionHandler handler;

	/**
	 * @param commandId
	 * @param handler
	 */
	protected BeyondCompareRepositoryAction(String commandId, BeyondCompareRepositoryActionHandler handler) {
